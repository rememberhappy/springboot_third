package com.example.aliclound.collection;

import com.example.aliclound.dto.IdcardDiscernDto;
import com.example.aliclound.dto.IdcardDiscernVo;
import com.example.aliclound.service.CertificationService;
...
public class CertificationCollection {
    ...
    public BussinessBo<Boolean> isRealNameAuthentication(Long accountId) throws Exception {
        /*
...
//    public Resp<String> humanFaceComparison(@RequestBody OauthHumanFaceComparisonDto dto) throws Exception {
//        if (humanFace) {
//            BussinessBo<HumanFaceComparisonBo> result = null;
//            if (humanFaceUseAli) {
//                // result = aLiHumanFaceService.humanFaceComparison(dto);
//            } else {
//                result = aiHumanFaceService.humanFaceComparison(dto);
//            }
//            userFaceComparisonService.insert(result.getData(), CommonInfoHolder.getSaasId(), CommonInfoHolder.getBranchId());
//            if (!result.status()) {
//                return Resp.error(result.getCode(), result.getMessage());
//            }
//        }
//        return Resp.success(EncryptUtils.MD5(CommonInfoHolder.getToken().concat("true")));
//    }
}